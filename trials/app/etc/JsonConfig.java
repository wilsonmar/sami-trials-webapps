...
public class JsonConfig implements IConfig {
	...
	public static final String SAMI_CONFIG_APPLICATION_ID = "/SAMI/config/trials-participants/application.id";
	public static final String SAMI_CONFIG_APPLICATION_NAME = "/SAMI/config/trials-participants/application.name";
	public static final String SAMI_CONFIG_APPLICATION_DESCRIPTION = "/SAMI/config/trials-participants/application.description";
	public static final String SAMI_CONFIG_CLIENT_SECRET = "/SAMI/config/trials-participants/client.secret";
	public static final String SAMI_CONFIG_REDIRECT_URI = "/SAMI/config/trials-participants/redirect.uri";
